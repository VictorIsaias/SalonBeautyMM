...
declare const VFileInput: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            "onClick:control"?: ((e: MouseEvent) => any) | undefined;
            "onMousedown:control"?: ((e: MouseEvent) => any) | undefined;
        }, "flat" | "reverse" | "error" | "active" | "direction" | "style" | "disabled" | "multiple" | "readonly" | "counter" | "messages" | "rounded" | "density" | "variant" | "modelValue" | "prependIcon" | "clearIcon" | "focused" | "errorMessages" | "maxErrors" | "rules" | "centerAffix" | "hideSpinButtons" | "persistentHint" | "clearable" | "dirty" | "persistentClear" | "singleLine" | "chips" | "counterSizeString" | "counterString" | "showSize">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
