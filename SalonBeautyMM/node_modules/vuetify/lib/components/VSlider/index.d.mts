...
declare const VSlider: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            onEnd?: ((value: number) => any) | undefined;
            onStart?: ((value: number) => any) | undefined;
        }, "reverse" | "max" | "error" | "direction" | "style" | "disabled" | "readonly" | "step" | "min" | "elevation" | "messages" | "rounded" | "density" | "modelValue" | "ripple" | "focused" | "errorMessages" | "maxErrors" | "rules" | "centerAffix" | "hideSpinButtons" | "persistentHint" | "showTicks" | "tickSize" | "trackSize" | "thumbLabel" | "thumbSize">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
