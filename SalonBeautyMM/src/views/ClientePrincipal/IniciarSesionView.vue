<template>
  <div class="fondo" style='height: 100vh;' align='center'>
    <v-container class="pt-16">
      <FormularioPrincipal class='w-50 h-100' tamañobtn='large' link='registrar' pie='Registrarse' @datos='login'
        ...
        <v-form @submit.prevent ref='form'>
          ...
          <v-text-field @keypress.enter="login" :append-icon="show1 ? 'mdi-eye' : 'mdi-eye-off'"
            ...
            label="Contraseña" variant="underlined">
          </v-text-field>
        </v-form>
...
// IMPORT DEL STORE DONDE SE GENERA EL TOKEN DE USUARIOS
...
let valid=ref(true)
var error = ref(false)
// FUNCION LOGIN DONDE VALIDA QUE EL USER TENGA LOS PARAMETROS REQUIERIDOS Y EL TOKEN
