...
const rClientes = async () => {
  try{
      const response = await fetch('http://18.116.31.102/usuarios');
...
const rCitas = async () => {
  try{
      const response = await fetch('http://18.116.31.102/citas_calendario');
      const data = await response.json();
...
const rCitasBloq = async () => {
  try{
      const response = await fetch('http://18.116.31.102/citas_calendario_cliente');
      const data = await response.json();
...
const rServicioCita = async () => {
  try{
      const response = await fetch('http://18.116.31.102/servicio_citas_calendario');
      const data = await response.json();
...
const rServicios = async () => {
  try{
      const response = await fetch('http://18.116.31.102/servicios_calendario');
      const data = await response.json();
...
const bloqueos_admin = async () => {
  try{
      const response = await fetch('http://18.116.31.102/servicio_bloqueos_calendario');
      const data = await response.json();
...
servCita.value.push({
 ...
 await fetch('http://18.116.31.102/crear_cita_calendario', {
    method: 'POST',
...
for(let i=0;i<=SCita.value.length-1;i++){
 inst={
  ...
  fetch('http://18.116.31.102/crear_sc_calendario', {
      method: 'POST',
      body: JSON.stringify(inst),
  }).then(response => response.json())
      .then(responsej => {
